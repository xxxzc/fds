      ...
      <div v-if="isLoading === false">
        <div class="is-title has-text-centered">
          <h3 class="title is-4">
            ...
            <span style="margin-left: 6px">课程信息</span>
          </h3>
        </div>
        <div class="columns is-mobile is-centered">
          <table class="table is-bordered is-striped" style="width: 400px">
            <tbody>
        ...
        <div class="is-title has-text-centered">
          <h3 class="title is-4">
            <i class="mdi mdi-calendar-check mdi-24px"/>
            <span style="margin-left: 6px">考核方式</span>
          </h3>
        </div>
        <div class="columns is-mobile is-centered">
        ...
        <div class="is-title has-text-centered">
          <h3 class="title is-4">
            ...
            <span style="margin-left: 6px">教学团队</span>
          </h3>
        </div>
        <h4 class="title is-5 is-title has-text-centered">教师</h4>
        <div class="columns is-mobile is-multiline is-centered">
          <div
            class="column is-half-mobile is-half-tablet is-half-desktop is-one-third-widescreen is-one-third-fullhd"
            style="min-width: 300px"
            v-for="p in infos.team.instructor.people"
            :key="p.name"
          >
            <div class="card">
        ...
        <h4 class="title is-5 is-title has-text-centered">助教们</h4>
        <div class="columns is-mobile is-multiline is-centered">
          <div
            class="column is-half-mobile is-half-tablet is-one-third-desktop is-one-quarter-widescreen is-one-quarter-fullhd"
            style="min-width: 220px"
            v-for="p in infos.team.tas.people"
            :key="p.name"
          >
            <div class="card">
              <div class="card-content">
